...
const ADDRESS_ERROR_CODE = {
  ...
  UPDATE_ADDRESS_ERROR: '15201',
  DELETE_ADDRESS_ERROR: '15302',
  GET_ADDRESS_ERROR: '15403'
}

/** 标签 */
const TAG_ERROR_CODE = {
  CREATE_TAG_ERROR: '16100',
  CREATE_TAG_UNIQUE_ERROR: '16101',
  UPDATE_TAG_ERROR: '16201',
  DELETE_TAG_ERROR: '16301',
}

const BRANCH_ERROR_CODE = {
  CREATE_BRANCH_ERROR: '17100',
  CREATE_BRANCH_UNIQUE_ERROR: '17101',
  UPDATE_BRANCH_ERROR: '17201',
  DELETE_BRANCH_ERROR: '17301',
}
